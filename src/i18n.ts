...
export const ui = {
  en: {
    ...
    nextLabel: 'Next rate-limit reset', latestLabel: 'Latest rate-limit rollout update', confirmedLabel: 'Latest confirmed usage reset', rolloutStatus: 'Rollout observed', resetConfirmedStatus: 'Reset confirmed', scopeSuffix: 'Human-curated and unofficial. Not affiliated with OpenAI.',
    ...
    waitingBody: 'Until a time is announced, this site does not predict the next reset from past intervals.', untimedHintTitle: 'Waiting for further details', untimedHintBody: 'The wording points toward a possible milestone reset tomorrow. A countdown will appear only if a usable time is published.',
    ...
    resetConfirmedTitle: 'Tibo confirms fresh usage for all ChatGPT Work and Codex users', resetConfirmedBody: 'The post confirms completion but gives no separate landing time. Its timestamp is used only as the public confirmation time.',
  ...
  'zh-CN': {
    ...
    nextLabel: 'Next rate-limit reset', latestLabel: 'Latest rate-limit rollout update', confirmedLabel: 'Latest confirmed usage reset', rolloutStatus: '已观察到落地', resetConfirmedStatus: '重置已落地', scopeSuffix: '本站为人工整理，非 OpenAI 官方信息。',
    ...
    waitingBody: '在时间出现之前，不根据历史记录推测下一次重置。', untimedHintTitle: '等待进一步消息', untimedHintBody: '原帖措辞指向明天可能进行一次里程碑重置；只有出现可用的公开时间后，本站才会显示倒计时。',
    rolloutTimingTitle: '部分用户的 Plus 账号已观察到新重置和 5 小时窗口', rolloutTimingBody: 'Tibo 未给出具体落地时刻，目前也没有公开信息证明所有 Plus 账号在同一时间完成变更。',
    resetConfirmedTitle: 'Tibo 确认所有 ChatGPT Work 与 Codex 用户已获得新额度', resetConfirmedBody: '原帖确认重置已经完成，但没有另行给出落地时刻；本站只将发帖时间作为公开确认时间。',
  ...
  'zh-TW': {
    ...
    nextLabel: 'Next rate-limit reset', latestLabel: 'Latest rate-limit rollout update', confirmedLabel: 'Latest confirmed usage reset', rolloutStatus: '已觀察到落地', resetConfirmedStatus: '重置已落地', scopeSuffix: '本站為人工整理，並非 OpenAI 官方資訊。',
    ...
    waitingBody: '在時間公佈之前，不根據歷史記錄推測下一次重置。', untimedHintTitle: '等待進一步消息', untimedHintBody: '原帖措辭指向明天可能進行一次里程碑重置；只有出現可用的公開時間後，本站才會顯示倒數計時。',
    rolloutTimingTitle: '部分使用者的 Plus 帳號已觀察到新重置與 5 小時視窗', rolloutTimingBody: 'Tibo 未提供具體落地時間，目前也沒有公開資訊證明所有 Plus 帳號在同一時間完成變更。',
    resetConfirmedTitle: 'Tibo 確認所有 ChatGPT Work 與 Codex 使用者已獲得新額度', resetConfirmedBody: '原帖確認重置已經完成，但沒有另行提供落地時間；本站只將發帖時間作為公開確認時間。',
...
export const currentCopy: Record<Locale, { headline: string; scope: string; context: string; note: string }> = {
  en: {
    headline: 'Tibo hints at a possible Codex reset tomorrow',
    scope: 'Codex users; exact plan coverage was not stated',
    context: 'Tibo said the dashboard might reach a new milestone to celebrate tomorrow and told readers to hold on to their Codex. This strongly suggests a possible usage reset on August 30, but the post does not explicitly say “reset.”',
    note: 'The post uses “might” and gives no reset time, time zone, or plan coverage. CRW records this as a hint rather than a confirmed reset announcement and does not start a countdown.',
  },
  'zh-CN': {
    headline: 'Tibo 暗示明天可能再次重置 Codex',
    scope: 'Codex 用户；原帖未说明具体套餐范围',
    context: 'Tibo 表示后台数据可能在明天达到一个值得庆祝的新里程碑，并提醒读者先留住 Codex 额度。这强烈暗示 8 月 30 日可能进行一次额度重置，但原帖没有直接写出“重置”。',
    note: '原帖使用 might，也没有给出重置时间、时区或套餐范围。本站将其记录为重置线索而非已确认预告，暂不启动倒计时。',
  },
  'zh-TW': {
    headline: 'Tibo 暗示明天可能再次重置 Codex',
    scope: 'Codex 使用者；原帖未說明具體方案範圍',
    context: 'Tibo 表示後台數據可能在明天達到一個值得慶祝的新里程碑，並提醒讀者先保留 Codex 額度。這強烈暗示 8 月 30 日可能進行一次額度重置，但原帖沒有直接寫出「重置」。',
    note: '原帖使用 might，也沒有提供重置時間、時區或方案範圍。本站將其記錄為重置線索而非已確認預告，暫不啟動倒數計時。',
  },
};
